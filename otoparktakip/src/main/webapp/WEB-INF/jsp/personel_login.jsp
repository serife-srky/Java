...
<div class="container login-container">
    <div class="row">
        <div class="col-md-12 login-form-1">
            ...
            <spring:url value="/personel/personel" var="loginURL" />
            <form:form modelAttribute="personel" method="post" action="${loginURL}" cssClass="form" >
            ...
            <button><a href="/yonetici/yonetici_login" style="color: black" >YÖNETİCİ GİRİŞ</a></button>
        </div>
    </div>
</div>
</body>
